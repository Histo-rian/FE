        ...
        <>
            ...
            <div className={`fadeContainer ${activeButton === "HOME" ? "visible" : ""}`}>
                <div className='loginContainer'>
                    <Button {...{ color: "black", type: "secondary", text: "LOGIN", onClick: () => navigate('/login') }} />
                    <Button {...{ color: "white", type: "secondary", text: "SIGNUP", onClick: () => navigate('/signup') }} />
                </div>
                ...
                <div className='mainContainer'>
                    <div className='main'>
                        ...
                        <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                            <Button {...{ color: "black", type: "secondary", text: "참여하기", onClick: () => navigate('/login') }} />
                        </div>
                    </div>
                </div>
            </section>
